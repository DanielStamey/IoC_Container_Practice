...
namespace IoC_Container
{
    public class Container : IContainer
    {
        ...
        {
            foreach (RegisteredObject currentRegisteredObject in registeredObjects.Where(o => o.TypeToResolve == typeToResolve))
            {
                yield return Resolve(currentRegisteredObject.TypeToResolve);
            }
        }
